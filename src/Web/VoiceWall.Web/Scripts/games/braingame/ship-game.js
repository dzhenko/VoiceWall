...
function getShipGame(containerID, difficulty) {
    ...
    asteroidImage.src = '/content/img/games/braingame/ship-game/asteroid.png';
    ...
    (function () {
        ...
        shipImageSprites.src = '/content/img/games/braingame/ship-game/shipSprite.png';
    ...
    function endGame() {
        ...
        function explode() {
            ...
            explosion.src = '/content/img/games/braingame/ship-game/explode.png';
